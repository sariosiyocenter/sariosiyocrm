...
const SPECS = [
  ...
  {
    method: 'PUT', path: '/api/logistics/drivers/:id/tarif', entity: 'logistics', action: 'update',
    describe: async ({ req, body }) => ({
      title: await nameOfRecord('user', req.params.id),
      summary: body?.tarif ? `Yo'l haqi tarifi: ${tarifMatni(body.tarif)}` : "Yo'l haqi tarifi olib tashlandi",
