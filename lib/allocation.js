...
/**
 * O'quvchi uchun amaldagi qoida: kartochkasida o'zi belgilangan bo'lsa —
 * o'sha (Student.payShare), bo'lmasa markaz qoidasi (Setting.multiCoursePay).
 * Server ham, brauzer ham shu funksiya bilan hisoblaydi — raqamlar bir xil.
 */
export function shareOpts(payShare, schoolRule) {
  ...
  return { rule: RULES.includes(schoolRule) && schoolRule !== 'foiz' ? schoolRule : 'eski' };
}
