...
export const MODULLAR = [
  ...
  { id: 'imtihonlar', nom: 'Imtihonlar', yol: '/exams', bolimlar: [
    { id: 'imtihonlar.imtihon', nom: 'Imtihonlar', izoh: 'Tuzish, kurslarga biriktirish, variantlar', tur: 'toliq', d: [2, 0, 0, 0] },
    { id: 'imtihonlar.savollar', nom: 'Savollar banki', izoh: "Savol qo'shish, Excel import", tur: 'toliq', d: [2, 0, 0, 0] },
    { id: 'imtihonlar.natija', nom: 'Natijalar va OMR skaner', izoh: '', tur: 'toliq', d: [2, 0, 0, 0] },
