...
r('GET', '/api/davomat-xabari', { k: ['kurslar.davomat', 'xabarlar.shablon'], d: 1 });
r('PUT', '/api/davomat-xabari', T('xabarlar.shablon'));
// To'lov xabari (services/tolovXabari.js): sozlama — shablon ruxsati,
// qayta yuborish va sinov SMS — yuborish ruxsati.
r('GET', '/api/tolov-xabari', { k: ['xabarlar.shablon', 'xabarlar.yuborish'], d: 1 });
r('PUT', '/api/tolov-xabari', T('xabarlar.shablon'));
