 ...
 *
 * `toISOString()` UTC qaytaradi — O'zbekiston UTC+5 bo'lgani uchun yarim
 * kechadan ertalab 5 gacha u kechagi sanani berardi. Kun jadvali ham,
 * yetkazish yozuvi ham shu sanaga bog'liq.
 */
export function toDateStr(date = new Date()) {
  return toISO(date instanceof Date ? date : new Date(date));
}
