    ...
    return (
        <form onSubmit={save} className="space-y-8">
            ...
            <div className="p-5 border border-dashed border-chiziq rounded-2xl text-[11px] font-bold text-matn-xira space-y-1.5">
                ...
                <p>1. <a href="https://merchant.paycom.uz" target="_blank" rel="noopener noreferrer" className="text-brand underline inline-flex items-center gap-1">Payme Business kabineti <ExternalLink size={10} /></a> da kassa yarating; Endpoint URL ga yuqoridagi webhook manzilini, hisob maydonlariga <span className="font-mono text-matn">order_id</span> (havola/QR) va <span className="font-mono text-matn">student_id</span> (Payme ilovasi katalogi, o'quvchi raqami) ni kiriting — ikkalasi ham ixtiyoriy, biri to'ldiriladi. Ixtiyoriy uchinchi maydon <span className="font-mono text-matn">course_id</span> — kurs kodi (pastdagi jadval).</p>
