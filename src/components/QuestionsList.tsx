        ...
        <div className="space-y-6 animate-in fade-in duration-500 max-w-7xl mx-auto">
            ...
            {importPreview && (
                <div className="fixed inset-0 z-[250] flex items-start sm:items-center justify-center overflow-y-auto p-4">
                    ...
                    <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-md p-4 space-y-4 border border-gray-100 dark:border-gray-800/50">
                        <div className="flex items-start justify-between border-b border-gray-100 dark:border-gray-800/50 pb-3">
                            <div>
                        ...
                        <div className="flex gap-3">
                            <div className="flex-1 bg-emerald-50 dark:bg-emerald-950/20 rounded-xl p-3 border border-emerald-100 dark:border-emerald-900/40 flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-emerald-500 uppercase tracking-wider font-bold">To'g'ri</p>
                                </div>
                            </div>
                            <div className="flex-1 bg-rose-50 dark:bg-rose-955/20 rounded-xl p-3 border border-rose-100 dark:border-rose-900/40 flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-rose-500 uppercase tracking-wider font-bold">Xatolik</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-2 pt-3 border-t border-dashed border-gray-100 dark:border-gray-800/50">
                            <button
                                onClick={() => setImportPreview(null)}
                                className="flex-1 py-2.5 rounded-xl border border-gray-100 dark:border-gray-800 text-[11px] font-bold uppercase tracking-wider text-gray-500 hover:bg-gray-55 cursor-pointer transition-all"
                            >
                                Bekor
                            </button>
                            <button
                                ...
                                className="flex-1 py-2.5 rounded-xl bg-[#1b6b6b] hover:bg-[#155252] text-white text-[11px] font-bold uppercase tracking-wider disabled:opacity-50 disabled:cursor-not-allowed transition-all cursor-pointer"
                            >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-800/50 shadow-sm p-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div className="flex items-center gap-2 flex-1 max-w-md">
                        <div className="relative flex-1">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2.5 bg-gray-55 dark:bg-gray-905 border border-gray-100 dark:border-gray-800 rounded-2xl text-xs font-bold text-gray-900 dark:text-white placeholder:text-gray-400 focus:border-[#1b6b6b] focus:ring-4 focus:ring-[#1b6b6b]/10 outline-none transition-all"
                            />
                        </div>
                        <button 
                            onClick={() => setShowFilters(!showFilters)}
                            className={`w-10 h-10 flex items-center justify-center rounded-2xl border transition-colors cursor-pointer ${
                                showFilters ? 'bg-teal-50 border-teal-200 text-[#1b6b6b] dark:bg-teal-950/20' : 'bg-white dark:bg-gray-800 border-gray-100 dark:border-gray-800 text-gray-400 hover:text-gray-650'
                            }`}
                        >
                            <Filter size={16} />
                        </button>
                    ...
                    <div className="flex items-center gap-2">
                        <label className="cursor-pointer px-4 py-2.5 bg-amber-50 dark:bg-amber-955/20 text-amber-600 dark:text-amber-405 border border-amber-100 dark:border-amber-900/40 rounded-xl text-[11px] font-bold uppercase tracking-wider hover:bg-amber-100 transition-colors flex items-center gap-1.5">
                            <FileUp size={14} />
                    ...
                    <div className="mt-4 pt-4 grid grid-cols-1 md:grid-cols-3 gap-4 border-t border-dashed border-gray-105 dark:border-gray-800/50 animate-in slide-in-from-top duration-300">
                        <div>
                            ...
                            <select 
                                ...
                                className="w-full px-3 py-2 bg-gray-55 dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl text-[11px] font-bold uppercase tracking-wider text-gray-900 dark:text-white outline-none focus:border-teal-500 cursor-pointer"
                            >
                        ...
                        <div>
                            <label className="text-[11px] font-bold text-gray-400 block mb-1.5 uppercase tracking-wider">Mavzu</label>
                            <select 
                                value={filters.topic}
                        ...
                        <div>
                            <label className="text-[11px] font-bold text-gray-400 block mb-1.5 uppercase tracking-wider">Qiyinlik Darajasi</label>
                            <select 
                    ...
                    <table className="w-full text-left border-collapse min-w-[800px]">
                        <thead>
                            <tr className="bg-gray-55 dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800/50">
                                ...
                                <th className="p-4 text-[11px] font-bold text-gray-400 uppercase tracking-wider text-center">Daraja</th>
                                <th className="p-4 text-[11px] font-bold text-gray-400 uppercase tracking-wider text-center">To'g'ri</th>
                                ...
                                <tr key={q.id} className="hover:bg-gray-50/50 dark:hover:bg-teal-950/20 transition-all cursor-pointer group" onClick={() => navigate(`/questions/${q.id}/edit`)}>
                                    ...
                                    <td className="p-4">
                                        <div className="flex flex-col gap-0.5">
                                            <span className="text-[11px] font-bold text-[#1b6b6b] uppercase tracking-wide">{q.subject}</span>
                                            <span className="text-[11px] font-bold text-gray-400 uppercase tracking-wider">{q.topic || 'Mavzusiz'}</span>
                                        </div>
                                    </td>
                            ...
                            {filteredQuestions.length === 0 && (
                                <tr>
                                    <td colSpan={6} className="p-16 text-center">
                                        ...
                                        <p className="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Hozircha savollar topilmadi</p>
                                    </td>
                                </tr>
                            )}
                        </tbody>
