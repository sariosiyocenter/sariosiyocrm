                                            ...
                                            <div className="flex items-center justify-between px-5 py-3 border-t border-gray-100 dark:border-gray-700/50">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <button onClick={() => setPayPage(p => Math.max(0, p - 1))} disabled={pPage === 0}
                                                        className="px-3 py-1 text-[11px] font-bold uppercase tracking-wider border border-gray-200 dark:border-gray-700 rounded-lg disabled:opacity-30 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer transition-all">Oldin</button>
                                                    ...
                                                    <button onClick={() => setPayPage(p => Math.min(pTotalPages - 1, p + 1))} disabled={pPage === pTotalPages - 1}
                                                        className="px-3 py-1 text-[11px] font-bold uppercase tracking-wider border border-gray-200 dark:border-gray-700 rounded-lg disabled:opacity-30 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer transition-all">Keyin</button>
                                                </div>
                                            </div>
                                        )}
                                    </div>
                        ...
                        {createdPaymentForReceipt ? (
                            <div className="space-y-6">
                                ...
                                <div className="bg-gray-50 dark:bg-gray-900/30 p-6 rounded-3xl border border-gray-100 dark:border-gray-750 font-mono text-xs text-gray-800 dark:text-gray-300 space-y-4 shadow-inner">
                                    ...
                                    <div className="border-t border-dashed border-gray-300 dark:border-gray-700 pt-3 text-center text-[11px] text-gray-400 uppercase tracking-wider font-bold">
                                    ...
                                    {!selectedStudent ? (
                                        ...
                                        <div className="p-4 bg-gray-50 dark:bg-gray-900/50 rounded-2xl border border-gray-100 dark:border-gray-800/80 relative space-y-3">
                                            <button type="button"
                                                ...
                                                className="absolute top-3.5 right-3.5 text-[11px] text-rose-500 font-bold uppercase tracking-wider hover:underline cursor-pointer bg-white dark:bg-gray-800 px-2.5 py-1 rounded-lg border border-gray-100 dark:border-gray-700">
                                                O'zgartirish
                                            </button>
                                            <div>
