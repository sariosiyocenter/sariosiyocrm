                ...
                <div className="p-5 flex flex-col md:flex-row gap-4 justify-between items-center border-b border-dashed border-gray-100 dark:border-gray-800/50">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <select 
                            ...
                            className="px-3 py-2 bg-gray-55 dark:bg-gray-905 border border-gray-100 dark:border-gray-800 rounded-xl text-[11px] font-bold uppercase tracking-wider outline-none focus:border-[#1b6b6b] text-gray-900 dark:text-white cursor-pointer"
                        >
                    ...
                    <table className="w-full text-left border-collapse min-w-[800px]">
                        <thead>
                            <tr className="bg-gray-55 dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800/50">
                                ...
                                <th className="p-4 text-[11px] font-bold text-gray-400 uppercase tracking-wider">Tur</th>
                                <th className="p-4 text-[11px] font-bold text-gray-400 uppercase tracking-wider text-center">Holat</th>
                            </tr>
                        </thead>
                                        ...
                                        <div className="flex items-center justify-center gap-2">
                                            {log.status === 'SENT' ? (
                                                <div className="inline-flex items-center gap-1.5 text-emerald-500 bg-emerald-50 dark:bg-emerald-950/20 px-2.5 py-1 rounded-lg border border-emerald-100 dark:border-emerald-900/40">
                                                    <CheckCircle size={12} />
                                                    <span className="text-[10px] font-bold uppercase tracking-wider">Yuborildi</span>
                                                </div>
                                            ) : log.status === 'FAILED' ? (
                                                <div 
                                                ...
                                                <div className="inline-flex items-center gap-1.5 text-amber-500 bg-amber-50 dark:bg-amber-955/20 px-2.5 py-1 rounded-lg border border-amber-100 dark:border-amber-900/40">
                                                    <Clock size={12} />
                                                    <span className="text-[10px] font-bold uppercase tracking-wider">Kutilmoqda</span>
                                                </div>
                                            )}
                            ...
                            {filteredLogs.length === 0 && !loading && (
                                <tr>
                                    <td colSpan={5} className="p-16 text-center">
                                        ...
                                        <p className="text-[11px] font-bold text-gray-400 uppercase tracking-wider">Hech qanday log topilmadi</p>
                                    </td>
                                </tr>
                            )}
                        </tbody>
