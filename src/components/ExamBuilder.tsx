            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-[11px] font-bold text-gray-400 uppercase tracking-widest mt-0.5">Mavzular bo'yicha savollarni saralash va qoidalar yaratish</p>
                    </div>
                </div>
                ...
                <button 
                    onClick={handleSave}
                    disabled={isSaving}
                    className="px-6 py-2.5 bg-[#1b6b6b] hover:bg-[#155252] text-white rounded-xl text-[11px] font-extrabold uppercase tracking-widest shadow-lg shadow-[#1b6b6b]/20 active:scale-95 transition-all flex items-center gap-1.5 cursor-pointer disabled:opacity-50"
                >
                    <Save size={14} />
                ...
                <div className="xl:col-span-1 space-y-6">
                    <div className="bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700/50 shadow-sm p-6">
                        <div className="flex items-center gap-3 mb-6 pb-4 border-b border-dashed border-gray-100 dark:border-gray-700/50">
                            ...
                            <div>
                                ...
                                <p className="text-[11px] font-bold text-gray-450 uppercase tracking-widest">Imtihon parametrlari</p>
                            </div>
                        </div>
                    ...
                    <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-6 shadow-xl relative overflow-hidden border border-slate-700/50">
                        ...
                        <div className="flex items-center gap-2 mb-6 relative z-10">
                            ...
                            <h3 className="text-[11px] font-black text-white uppercase tracking-widest">Imtihon Blueprinti</h3>
                        </div>

                        <div className="space-y-4 relative z-10">
                            <div className="flex justify-between items-end border-b border-slate-700/50 pb-3">
                                <span className="text-[11px] font-bold text-slate-400 uppercase tracking-widest">Fanlar Soni</span>
                                <span className="text-sm font-black text-white">{blocks.length} ta fan</span>
                            </div>
                            <div className="flex justify-between items-end border-b border-slate-700/50 pb-3">
                                <span className="text-[11px] font-bold text-slate-400 uppercase tracking-widest">Jami Savollar</span>
                            ...
                            <div className="flex justify-between items-end">
                                <span className="text-[11px] font-bold text-slate-400 uppercase tracking-widest">Maksimal Ball</span>
                ...
                <div className="xl:col-span-2 space-y-6">
                    <div className="flex items-center justify-between">
                        ...
                        <button 
                            ...
                            className="px-4 py-2.5 bg-teal-50 dark:bg-teal-950/20 text-[#1b6b6b] border border-teal-100 dark:border-teal-900/40 rounded-xl text-[11px] font-extrabold uppercase tracking-widest hover:bg-teal-100 transition-all flex items-center gap-1.5 cursor-pointer"
                        >
                            <Plus size={14} />
                            Blok (Fan) Qo'shish
                        </button>
                            ...
                            <div key={block.id} className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700/50 rounded-3xl overflow-hidden shadow-sm transition-all">
                                    ...
                                    <div className="flex flex-wrap items-center gap-3">
                                        ...
                                        <div className="flex flex-wrap gap-3 items-center">
                                            <div className="space-y-1">
                                                <label className="text-[10px] font-bold text-gray-405 uppercase tracking-widest ml-1">Fan Tanlang</label>
                                                <select 
                                                    className="px-3 py-1.5 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl text-[11px] font-bold uppercase tracking-widest focus:border-teal-500 outline-none text-gray-900 dark:text-white cursor-pointer"
                                                    value={block.subject}
                                            ...
                                            <div className="space-y-1">
                                                <label className="text-[10px] font-bold text-gray-405 uppercase tracking-widest ml-1">Ball / Savol</label>
                                                <input type="number" step="0.1" 
                                                    className="w-20 px-3 py-1.5 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl text-[11px] font-bold uppercase tracking-widest focus:border-teal-500 outline-none text-amber-600"
                                ...
                                <div className="p-5 space-y-4">
                                    <div className="flex items-center justify-between mb-1">
                                        <h4 className="text-[11px] font-black text-gray-400 uppercase tracking-widest">Mavzu bo'yicha qoidalar</h4>
                                        <button 
                                            onClick={() => handleAddRule(block.id)}
                                            className="text-[11px] font-black text-[#1b6b6b] uppercase tracking-widest flex items-center gap-1 hover:opacity-70 cursor-pointer"
                                        >
                                    ...
                                    <div className="space-y-3">
                                            ...
                                            return (
                                                <div key={rIdx} className="grid grid-cols-12 gap-3 items-end bg-gray-55 dark:bg-gray-900/30 p-3.5 rounded-2xl border border-transparent hover:border-gray-100 transition-all">
                                                    <div className="col-span-5 space-y-1.5">
                                                        <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Mavzu</label>
                                                        <select 
                                                            className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl text-[11px] font-bold uppercase tracking-widest focus:border-teal-500 outline-none text-gray-900 dark:text-white cursor-pointer"
                                                            value={rule.topic}
                                                    ...
                                                    <div className="col-span-3 space-y-1.5">
                                                        <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest ml-1">Soni</label>
                                                        <input type="number" 
                                                            className={`w-full px-3 py-2 bg-white dark:bg-gray-800 border ${isError ? 'border-rose-500 ring-2 ring-rose-500/10' : 'border-gray-100 dark:border-gray-700'} rounded-xl text-[11px] font-bold uppercase tracking-widest focus:border-teal-500 outline-none`}
                                                            value={rule.count || ''}
                                                            onChange={e => handleUpdateRule(block.id, rIdx, 'count', Number(e.target.value))}
                                                        />
                                                    </div>
                                                    <div className="col-span-3 pb-2">
                                                        <div className={`flex items-center gap-1 text-[11px] font-black uppercase ${isError ? 'text-rose-500' : 'text-gray-450'}`}>
                                        ...
                                        {block.topicRules.length === 0 && (
                                            <div className="py-8 text-center border border-dashed border-gray-100 dark:border-gray-800 rounded-2xl">
                                                ...
                                                <p className="text-[11px] font-bold text-gray-400 uppercase tracking-widest">Mavzu qoidalari mavjud emas</p>
                                            </div>
                                        )}
                                    </div>
                                </div>
