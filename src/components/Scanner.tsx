            ...
            <div className="flex-1 overflow-y-auto">
                ...
                {step === 'idle' && (
                    <div className="flex flex-col items-center justify-center h-full p-12 space-y-8 text-center">
                        ...
                        <button
                            onClick={startQRScan}
                            className="px-12 py-4 bg-teal-600 text-white rounded-[1.5rem] text-[11px] font-bold tracking-[0.2em] shadow-2xl shadow-teal-500/20 hover:bg-teal-500 transition-all"
                        >
                            Kamerani Yoqish
                        </button>
                    </div>
                ...
                {step === 'qr_scanning' && (
                    <div className="relative w-full h-full min-h-[60vh] flex items-center justify-center bg-black">
                        ...
                        <p className="absolute bottom-8 text-[11px] font-bold text-white/60">QR kodni ramkaga joylang</p>
                    </div>
                )}
                    ...
                    <div className="p-5 space-y-5">
                        ...
                        <div className="bg-teal-900/30 border border-teal-700/50 rounded-2xl p-4 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-teal-400 text-[11px] font-bold">
                        ...
                        <button
                            ...
                            className="w-full py-4 bg-teal-600 text-white rounded-2xl text-[11px] font-bold tracking-[0.2em] hover:bg-teal-500 disabled:opacity-40 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2"
                        >
                ...
                {step === 'done' && savedResult && (
                    <div className="flex flex-col items-center justify-center h-full p-10 space-y-8 text-center">
                        ...
                        <div>
                            <p className="text-teal-400 text-[11px] font-bold mb-1">Muvaffaqiyatli saqlandi</p>
                        ...
                        <div className="flex flex-col w-full gap-3">
                            <button
                                ...
                                className="w-full py-4 bg-teal-600 text-white rounded-2xl text-[11px] font-bold tracking-[0.2em] hover:bg-teal-500 transition-all"
                            >
                                Keyingi Varaqa
                            </button>
                            <button
                                onClick={handleClose}
                                className="w-full py-4 bg-white/10 text-white rounded-2xl text-[11px] font-bold tracking-[0.2em] hover:bg-white/20 transition-all"
                            >
                                Skanerni Yopish
                            </button>
                        </div>
