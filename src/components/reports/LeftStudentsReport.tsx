        ...
        <div className="p-6 space-y-6 animate-in fade-in duration-500">
            ...
            <ReportCard>
                <SectionHeader 
                    ...
                    action={
                        <button className="flex items-center gap-2 px-4 py-2 bg-rose-600 text-white rounded-xl text-[11px] font-extrabold uppercase tracking-widest hover:bg-rose-500 transition-all">
