            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                <ReportCard>
                    ...
                    {stats.dept.length > 0 ? (
                        ...
                        <div className="h-[180px] flex items-center justify-center text-[11px] font-bold text-matn-xira">Ma'lumot mavjud emas</div>
                    )}
                </ReportCard>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <ReportCard className="flex flex-col items-center justify-center text-center">
                        ...
                        <p className="text-2xl font-black text-matn tabular-nums">{students.length}</p>
                        <p className="text-[11px] font-bold text-matn-xira">Jami O'quvchi</p>
                    </ReportCard>
                    <ReportCard className="flex flex-col items-center justify-center text-center">
                        <Briefcase className="text-emerald-500 mb-2" size={24} />
                        <p className="text-2xl font-black text-matn tabular-nums">{teachers.length}</p>
                        <p className="text-[11px] font-bold text-matn-xira">Ustozlar</p>
                    </ReportCard>
                    <ReportCard className="flex flex-col items-center justify-center text-center">
                        <Activity className="text-violet-500 mb-2" size={24} />
                        <p className="text-2xl font-black text-matn tabular-nums">{groups.length}</p>
                        <p className="text-[11px] font-bold text-matn-xira">Kurslar</p>
                    </ReportCard>
                    <ReportCard className="flex flex-col items-center justify-center text-center">
                        <Target className="text-amber-500 mb-2" size={24} />
                        <p className="text-2xl font-black text-matn tabular-nums">{leads.length}</p>
                        <p className="text-[11px] font-bold text-matn-xira">Leadlar</p>
                    </ReportCard>
                </div>
            </div>
        </div>
