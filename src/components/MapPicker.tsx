            ...
            <div className="bg-white dark:bg-gray-800 w-full max-w-4xl rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 border border-gray-100 dark:border-gray-700 min-h-[500px] h-[80vh] flex flex-col" onClick={e => e.stopPropagation()}>
                <div className="px-10 py-6 flex items-center justify-between border-b border-gray-50 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/50">
                    <div>
                        ...
                        <p className="text-[11px] font-bold text-gray-400 dark:text-gray-500 mt-1 uppercase tracking-widest leading-none pt-1">Xarita orqali o'quvchi yashash joyini belgilang</p>
                    </div>
                ...
                <div className="p-8 bg-gray-50/50 dark:bg-gray-900/50 border-t border-gray-100 dark:border-gray-700 flex flex-col sm:flex-row items-center justify-between gap-6">
                    <div className="flex-1 w-full">
                        <p className="text-[11px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-2 ml-1">Koordinatalar</p>
                    ...
                    <div className="flex items-center gap-4 w-full sm:w-auto">
                        <button onClick={onClose} className="flex-1 sm:flex-none px-8 py-4 bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-gray-700 rounded-2xl text-[11px] font-bold uppercase tracking-widest hover:bg-gray-50 dark:hover:bg-gray-700 transition-all">
                            Bekor qilish
                        </button>
                        <button onClick={handleConfirm} className="flex-1 sm:flex-none px-12 py-4 bg-sky-600 dark:bg-sky-500 text-white rounded-2xl text-[11px] font-bold uppercase tracking-widest hover:bg-sky-500 active:scale-[0.98] transition-all shadow-xl shadow-sky-500/20 flex items-center justify-center gap-2">
                            <Check size={18} />
                            Tasdiqlash
                        </button>
                    </div>
