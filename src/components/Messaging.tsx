...
export default function Messaging() {
  ...
  const btnOutline = "flex items-center justify-center gap-1 px-2.5 py-1.5 border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg text-[11px] font-bold text-slate-500 dark:text-slate-450   transition-all cursor-pointer";
          ...
          <div className="lg:col-span-5 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm p-4 space-y-5">
              ...
              <div>
                ...
                <div className="grid grid-cols-4 gap-1 bg-slate-55 dark:bg-slate-800/80 p-1 rounded-xl border border-slate-200 dark:border-slate-700/50">
                  ...
                  <button
                    ...
                    className={`py-1.5 rounded-lg text-[11px] font-bold cursor-pointer transition-all ${recipientTo === 'FATHER' ? 'bg-white dark:bg-slate-700 text-brand dark:text-brand shadow-sm' : 'text-slate-500'}`}
                  >
                    Otasi
                  </button>
                  <button
                    onClick={() => setRecipientTo('MOTHER')}
                    className={`py-1.5 rounded-lg text-[11px] font-bold cursor-pointer transition-all ${recipientTo === 'MOTHER' ? 'bg-white dark:bg-slate-700 text-brand dark:text-brand shadow-sm' : 'text-slate-500'}`}
                  >
                    Onasi
                  </button>
                  <button
            ...
            <div className="space-y-3 pt-3 border-t border-dashed border-slate-100 dark:border-slate-800">
              ...
              {recipientEntries.length > 0 ? (
                    ...
                    return (
                      <div key={entry.key} className="py-2.5 flex items-center justify-between text-[12px] hover:bg-white dark:hover:bg-slate-800/40 px-2 rounded-xl transition-all">
                        ...
                        <div className="flex items-center gap-2 text-right">
                          ...
                          {entry.telegramId ? (
                            <span className="text-[10px] font-bold px-1.5 py-0.5 rounded bg-sky-50 dark:bg-sky-950/25 text-sky-500 border border-sky-100/40 dark:border-sky-900/25">TG</span>
                          ) : (
                            <span className="text-[10px] font-bold px-1.5 py-0.5 rounded bg-purple-50 dark:bg-purple-950/25 text-purple-500 border border-purple-100/40 dark:border-purple-900/25">SMS</span>
                          )}
                        </div>
                      </div>
                    );
                ...
                <div className="border border-slate-100 dark:border-slate-800 rounded-2xl p-4 text-center bg-slate-50/40 dark:bg-slate-950/20 text-[11px] font-bold text-slate-405 dark:text-slate-505">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2 bg-slate-55 dark:bg-slate-800/80 p-1 rounded-xl border border-slate-200 dark:border-slate-700/50">
                  <button
                    ...
                    className={`py-1.5 rounded-lg text-[11px] font-bold cursor-pointer transition-all ${channel === 'SMS' ? 'bg-white dark:bg-slate-700 text-brand dark:text-brand shadow-sm' : 'text-slate-500'}`}
                  >
                    SMS
                  </button>
                  <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            {templates.length === 0 && (
              <div className="col-span-full bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 p-16 text-center">
                ...
                <p className="text-[11px] font-bold text-slate-400">Hozircha shablonlar yaratilmagan</p>
              </div>
            )}
          </div>
        </div>
            ...
            <div className="lg:col-span-4 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm p-4 space-y-4">
              <div className="flex justify-between items-center border-b border-dashed border-slate-100 dark:border-slate-800 pb-3">
                ...
                {selectedCampaignId !== null && (
                  <button onClick={() => setSelectedCampaignId(null)} className="text-[11px] font-bold text-rose-500 hover:underline cursor-pointer">Filtrni ochish</button>
                )}
              </div>
            ...
            <div className="lg:col-span-8 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden">
              ...
              <div className="p-5 flex flex-col md:flex-row gap-4 justify-between items-center border-b border-dashed border-slate-100 dark:border-slate-800">
                <div className="flex items-center gap-3">
                  ...
                  {selectedCampaignId !== null && (
                    <span className="text-[11px] font-bold px-2 py-0.5 bg-brand/10 dark:bg-brand/40 text-brand dark:text-brand border border-brand/20 dark:border-brand/30">
              ...
              <div className="p-4 bg-brand/10/40 dark:bg-brand/10 border-b border-brand/20 dark:border-brand/40 flex flex-wrap items-center gap-4">
                <span className="text-[11px] font-bold text-slate-500 dark:text-slate-400">Xatoliklarni qayta jo'natish:</span>
                {Object.values(selectedLogIds).filter(Boolean).length > 0 ? (
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="text-[11px] font-bold text-slate-400 dark:text-slate-500">Sana bo'yicha:</span>
                    <input
                      type="date"
                ...
                <table className="w-full text-left border-collapse min-w-[700px]">
                  <thead>
                    <tr className="bg-slate-55 dark:bg-slate-850 border-b border-slate-100 dark:border-slate-800">
                      ...
                      <th className="p-3 text-[11px] font-bold text-slate-400">Sana</th>
                      <th className="p-3 text-[11px] font-bold text-slate-400">Qabul qiluvchi</th>
                      <th className="p-3 text-[11px] font-bold text-slate-400">Kanal</th>
                      <th className="p-3 text-[11px] font-bold text-slate-400">Xabar matni</th>
                      <th className="p-3 text-[11px] font-bold text-slate-400 text-center">Holat</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                    {displayLogs.map(log => (
                      <tr key={log.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/20 transition-all text-slate-700 dark:text-slate-300">
                        ...
                        <td className="p-3">
                          <span className={`text-[11px] font-bold px-1.5 py-0.5 rounded ${log.channel === 'TELEGRAM' ? 'bg-sky-50 dark:bg-sky-950/20 text-sky-500' : 'bg-purple-50 dark:bg-purple-950/20 text-purple-500'}`}>
                            {log.channel}
                          </span>
                        </td>
                        <td className="p-3">
                          ...
                          <div className="flex items-center justify-center gap-2">
                            {log.status === 'SENT' ? (
                              ...
                              <div className="inline-flex items-center gap-1 text-amber-500 bg-amber-50 dark:bg-amber-955/20 px-2 py-0.5 rounded border border-amber-100 dark:border-amber-900/30">
                                <Clock size={10} />
                                <span className="text-[10px] font-bold">KUTISH</span>
                              </div>
                            )}
        ...
        <div className="fixed inset-0 z-[1000] flex items-start sm:items-center justify-center overflow-y-auto p-4">
          ...
          <div className="relative bg-white dark:bg-slate-900 rounded-2xl max-w-lg w-full p-4 space-y-4 shadow-2xl border border-slate-100 dark:border-slate-800 animate-in zoom-in-95 duration-200">
            <div className="flex justify-between items-center border-b border-dashed border-slate-100 dark:border-slate-800 pb-3">
              ...
              <span className="text-[11px] font-bold text-slate-400 tabular-nums">{activeSelectedCount}/{filteredRecipients.length} ta</span>
            </div>
              ...
              {filteredRecipients.map(st => (
                <div key={st.id} className="py-2.5 flex items-center justify-between text-xs">
                  ...
                  <div className="flex items-center gap-1.5">
                    {st.telegramId ? (
                      <span className="text-[11px] font-bold px-1.5 py-0.5 rounded bg-sky-50 dark:bg-sky-950/20 text-sky-500 border border-sky-100 dark:border-sky-900/30">Telegram</span>
                    ) : (
                      <span className="text-[11px] font-bold px-1.5 py-0.5 rounded bg-purple-50 dark:bg-purple-950/20 text-purple-500 border border-purple-100 dark:border-purple-900/30">SMS Faqat</span>
                    )}
                  </div>
                </div>
              ))}
