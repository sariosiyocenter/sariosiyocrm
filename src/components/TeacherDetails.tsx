...
export default function TeacherDetails() {
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            {/* Back Button */}
            <button onClick={() => navigate('/teachers')} className="flex items-center gap-2 text-gray-400 dark:text-gray-500 hover:text-[#1b6b6b] transition-all text-[11px] font-extrabold uppercase tracking-widest group cursor-pointer">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700/50 shadow-sm overflow-hidden">
                        ...
                        <div className="pt-14 pb-6 px-6 text-center">
                            ...
                            <p className="text-[11px] font-bold text-gray-400 uppercase tracking-widest mt-1">ID: #{teacher.id}</p>
                            <div className="mt-4 flex justify-center">
                                <span className={`px-2.5 py-0.5 rounded-md text-[10px] font-black border uppercase tracking-wider ${teacher.status === 'Faol' ? 'bg-emerald-50 text-emerald-600 border-emerald-100 dark:bg-emerald-950/20 dark:text-emerald-400' : 'bg-gray-55 text-gray-400 border-gray-100 dark:bg-gray-900/50'}`}>
                                    {teacher.status}
                                </span>
                            </div>
                        </div>
                    ...
                    <div className="bg-[#1b6b6b] rounded-3xl p-6 text-white shadow-lg shadow-[#1b6b6b]/20 relative overflow-hidden">
                        <span className="text-[11px] font-black text-teal-100 uppercase tracking-widest block mb-4">Maosh Hisobi</span>
                        <div className="space-y-4">
                            <div>
                                <span className="text-[11px] text-teal-200 font-bold uppercase tracking-widest block">Joriy oylik</span>
                            ...
                            {kpiDetails && (
                                <div className="flex items-center justify-between pt-3 border-t border-white/10">
                                    <span className="text-[11px] text-teal-200 font-bold uppercase tracking-widest">KPI ulushi</span>
                                    <span className="text-[11px] font-black bg-white/20 px-2 py-0.5 rounded text-white">{kpiDetails.percentage}%</span>
                                </div>
                            )}
                        </div>
                    </div>
                                ...
                                <div className="space-y-8 animate-in fade-in duration-300">
                                    ...
                                    <div>
                                        <div className="flex items-center justify-between mb-4 pb-2 border-b border-gray-55 dark:border-gray-700/50">
                                            <span className="text-[11px] font-black text-gray-400 uppercase tracking-widest">Biriktirilgan Kurslar</span>
                                            <span className="text-[11px] font-extrabold text-[#1b6b6b] uppercase tracking-widest bg-[#1b6b6b]/5 px-2.5 py-0.5 rounded border border-[#1b6b6b]/10">Jami: {teacherGroups.length} ta</span>
                                        </div>
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    ...
                                                    <div className="space-y-4 w-full">
                                                        <div className="flex items-center gap-3">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-[11px] font-bold text-gray-400 mt-0.5 uppercase tracking-widest">{group.days}</p>
                                                            </div>
                                                        </div>
                                            ...
                                            {teacherGroups.length === 0 && (
                                                <p className="col-span-2 text-center py-12 text-[11px] text-gray-400 font-bold uppercase tracking-widest">Kurslar mavjud emas</p>
                                            )}
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="border border-gray-100 dark:border-gray-700/50 rounded-3xl p-6 bg-white dark:bg-gray-800/50 shadow-sm">
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            <div className="md:col-span-2 space-y-6">
                                                <div>
                                                    <span className="text-[11px] font-black text-gray-400 uppercase tracking-widest block mb-2">HISOBLASH TURI</span>
                                                    <span className="text-[11px] font-black text-[#1b6b6b] bg-[#1b6b6b]/5 border border-[#1b6b6b]/10 px-3 py-1.5 rounded-lg inline-block uppercase tracking-wider">
                                                        {teacher.salaryType === 'FIXED' ? 'Fiks oylik' : teacher.salaryType === 'KPI' ? 'KPI (Ulush)' : 'Fiks + KPI'}
                                                    </span>
                                                </div>
                                                {kpiDetails && (
                                                    <div className="space-y-3">
                                                        <span className="text-[11px] font-black text-gray-400 uppercase tracking-widest block">KPI TAFSILOTLARI</span>
                                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                            <div className="bg-gray-55 dark:bg-gray-900/30 p-4 rounded-xl border border-gray-100 dark:border-gray-700/50">
                                                                <span className="text-[10px] font-black text-gray-400 block mb-1 uppercase tracking-widest">Kurslar tushumi</span>
                                                            ...
                                                            <div className="bg-gray-55 dark:bg-gray-900/30 p-4 rounded-xl border border-gray-100 dark:border-gray-700/50">
                                                                <span className="text-[10px] font-black text-gray-400 block mb-1 uppercase tracking-widest">Ulush foizi</span>
                                            ...
                                            <div className="bg-gradient-to-br from-[#1b6b6b] to-[#268c8c] p-6 rounded-2xl flex flex-col items-center justify-center text-white text-center">
                                                <span className="text-[11px] font-bold uppercase tracking-widest mb-1.5 text-teal-100">UMUMIY MIQDOR</span>
                                                <span className="text-2xl font-black tracking-tight tabular-nums">{calculatedSalary.toLocaleString()}</span>
                                                <span className="text-[10px] font-black mt-3 text-teal-200 uppercase tracking-widest border border-white/20 px-3 py-1 rounded-full">UZS</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-6 animate-in fade-in duration-300">
                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 bg-gray-55 dark:bg-gray-900/40 border border-gray-100 dark:border-gray-700/50 rounded-2xl">
                                        <div>
                                            ...
                                            <p className="text-[11px] font-bold text-gray-450 uppercase tracking-widest mt-1">{new Date().toLocaleDateString('uz-UZ', { month: 'long' })} oyi</p>
                                        </div>
                                        <button onClick={() => setShowAttendanceModal(true)} 
                                            className="px-4 py-2 bg-[#1b6b6b] hover:bg-[#155252] text-white rounded-xl text-[11px] font-extrabold uppercase tracking-widest transition-all cursor-pointer shadow-lg shadow-[#1b6b6b]/20">
                                            Davomat belgilash
                                        </button>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                                        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-100 dark:border-gray-700 shadow-sm group hover:border-emerald-300">
                                            <span className="text-[11px] font-bold text-gray-400 mb-2 uppercase tracking-widest block group-hover:text-emerald-500 transition-colors">KELDI</span>
                                        ...
                                        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-100 dark:border-gray-700 shadow-sm group hover:border-rose-300">
                                            <span className="text-[11px] font-bold text-gray-400 mb-2 uppercase tracking-widest block group-hover:text-rose-500 transition-colors">KELMADI</span>
                                        ...
                                        <table className="w-full text-left border-collapse">
                                            <thead>
                                                <tr className="bg-gray-55 dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800">
                                                    ...
                                                    <th className="p-4 text-center text-[11px] font-black text-gray-400 uppercase tracking-widest">Holati</th>
                                                </tr>
                                            </thead>
                                            <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                                                    ...
                                                    <tr key={a.id} className="hover:bg-gray-50/50 dark:hover:bg-gray-750/30 transition-colors">
                                                        ...
                                                        <td className="p-4">
                                                            <div className="flex justify-center">
                                                                <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-lg text-[11px] font-black border uppercase tracking-wider ${a.status === 'Keldi' ? 'bg-emerald-50 text-emerald-600 border-emerald-100 dark:bg-emerald-950/20 dark:text-emerald-400' : 'bg-rose-50 text-rose-600 border-rose-100 dark:bg-rose-950/20 dark:text-rose-400'}`}>
                                                ...
                                                {currentMonthAttendances.length === 0 && (
                                                    <tr><td colSpan={2} className="p-10 text-center text-gray-400 text-[11px] font-bold uppercase tracking-widest">Shu oy bo'yicha ma'lumot yo'q</td></tr>
                                                )}
                                            </tbody>
                                        </table>
                                    </div>
                    ...
                    <div className="relative bg-white dark:bg-gray-800 rounded-[2rem] border border-gray-100 dark:border-gray-700/50 shadow-2xl w-full max-w-sm p-8">
                        <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-50 dark:border-gray-700/50">
                            <div>
                                ...
                                <p className="text-[11px] font-bold text-[#1b6b6b] uppercase tracking-widest mt-0.5">Bugungi sana uchun</p>
                            </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            >
                                ...
                                <span className="text-[11px] font-black text-emerald-600 dark:text-emerald-400 group-hover:text-white uppercase tracking-widest">KELDI</span>
                            </button>
                            <button
                                onClick={() => {
                                    addTeacherAttendance({
                            ...
                            >
                                ...
                                <span className="text-[11px] font-black text-rose-600 dark:text-rose-400 group-hover:text-white uppercase tracking-widest">KELMADI</span>
                            </button>
                        </div>
                    </div>
                </div>
