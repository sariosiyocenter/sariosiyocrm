...
export default function TeacherDetails() {
    ...
    return (
        <div className="space-y-6 pb-12 animate-in fade-in duration-700">
            <button onClick={() => navigate('/teachers')} className="flex items-center gap-2 text-[#4a5568] hover:text-sky-600 dark:hover:text-sky-400 transition-all text-[10px] font-bold uppercase tracking-widest group">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-start">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="bg-[#141c27] rounded-3xl shadow-sm border border-white/5 overflow-hidden transition-colors">
                        <div className="h-32 bg-gradient-to-br from-sky-500 to-sky-700 relative">
                            <div className="absolute -bottom-12 left-1/2 -translate-x-1/2 rounded-3xl bg-[#141c27] p-1.5 shadow-xl shadow-sky-500/10 transition-colors">
                        ...
                        <div className="pt-16 pb-8 px-6 text-center">
                            <h2 className="text-2xl font-bold text-white uppercase tracking-tight">{teacher.name}</h2>
                            <p className="text-[10px] font-bold text-[#4a5568] mt-2 uppercase tracking-widest leading-none">ID: #{teacher.id}</p>
                        ...
                        <div className="px-6 pb-8 space-y-4">
                            <div className="h-px bg-white/5 w-full mb-2 border-t border-dashed border-white/5"></div>
                ...
                <div className="lg:col-span-3">
                    <div className="bg-[#141c27] rounded-3xl shadow-sm border border-white/5 overflow-hidden min-h-[600px] transition-colors">
                        ...
                        <div className="p-8">
                                ...
                                <div className="space-y-10 animate-in fade-in duration-500">
                                    ...
                                    <div>
                                        <div className="flex items-center justify-between mb-6">
                                            <h4 className="text-sm font-bold text-[#4a5568] uppercase tracking-widest">Biriktirilgan Guruhlar</h4>
                                            <span className="text-[10px] font-bold text-[#4a5568] uppercase tracking-widest bg-white/5 px-3 py-1 rounded-lg border border-white/5 items-center gap-2 flex">Jami: {teacherGroups.length} ta</span>
                                        </div>
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                            {teacherGroups.map(group => (
                                                <div key={group.id} onClick={() => navigate(`/groups/${group.id}`)} 
                                                    className="group bg-[#141c27] p-6 rounded-3xl border border-white/5 hover:border-sky-300 dark:hover:border-sky-500 transition-all cursor-pointer shadow-sm hover:shadow-xl hover:shadow-sky-500/5 hover:scale-[1.02] active:scale-[0.98]">
                                                    <div className="flex items-start justify-between">
                                                        <div className="space-y-5 w-full">
                                                            <div className="flex items-center gap-4">
                                                                ...
                                                                <div>
                                                                    <h5 className="font-bold text-white group-hover:text-sky-600 dark:group-hover:text-sky-400 transition-colors text-xl uppercase tracking-tight">{group.name}</h5>
                                                                    <p className="text-[10px] font-bold text-[#4a5568] mt-1 uppercase tracking-widest">{group.days}</p>
                                                                </div>
                                                            </div>
                                                            <div className="flex items-center gap-6 pt-5 border-t border-dashed border-white/5">
                                            ...
                                            {teacherGroups.length === 0 && (
                                                <div className="col-span-2 text-center py-20 border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-3xl bg-gray-50/50 dark:bg-gray-900/20">
                                                    <p className="text-[10px] font-bold text-[#4a5568] uppercase tracking-widest">Guruhlar mavjud emas</p>
                                                </div>
                                            )}
                                        </div>
                                    </div>
                            ...
                            {activeTab === 'oylik' && (
                                <div className="space-y-8 animate-in fade-in duration-300">
                                    <div className="p-6 bg-white/[0.03] border border-gray-200/50 dark:border-gray-700/50 rounded-2xl">
                                        <h4 className="text-sm font-bold text-[#4a5568] uppercase tracking-widest">Oylik hisob-kitobi</h4>
                                    </div>
                                    
                                    <div className="border border-white/5 rounded-3xl p-8 bg-white/[0.03] shadow-sm transition-colors">
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                                            <div className="md:col-span-2 space-y-8">
                                                <div>
                                                    <p className="text-[10px] font-bold text-[#4a5568] uppercase tracking-widest mb-3 ml-1">HISOBLASH TURI</p>
                                                ...
                                                {kpiDetails && (
                                                    <div className="space-y-4">
                                                        <p className="text-[10px] font-bold text-[#4a5568] uppercase tracking-widest mb-3 ml-1">KPI TAFSILOTLARI</p>
                                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                                            <div className="bg-white/[0.03] p-5 rounded-2xl border border-white/5 shadow-sm">
                                                                <span className="text-[10px] font-bold text-[#4a5568] block mb-2 uppercase tracking-widest">Guruhlar tushumi</span>
                                                                <span className="text-xl font-bold text-white tracking-tight tabular-nums">{kpiDetails.groupRevenue.toLocaleString()} <span className="text-[10px] text-gray-400">UZS</span></span>
                                                            </div>
                                                            <div className="bg-white/[0.03] p-5 rounded-2xl border border-white/5 shadow-sm">
                                                                <span className="text-[10px] font-bold text-[#4a5568] block mb-2 uppercase tracking-widest">Ulush foizi</span>
                                                                <span className="text-xl font-bold text-white tracking-tight tabular-nums">{kpiDetails.percentage}%</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                )}
                            ...
                            {activeTab === 'davomat' && (
                                <div className="space-y-8 animate-in fade-in duration-300">
                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-6 bg-white/[0.03] border border-white/5 shadow-sm rounded-3xl transition-colors">
                                        <div>
                                            <h3 className="text-lg font-bold text-white uppercase tracking-tight">Ishga kelishi</h3>
                                            <p className="text-[10px] font-bold text-[#4a5568] mt-1.5 uppercase tracking-widest">{new Date().toLocaleDateString('uz-UZ', { month: 'long' })} oyi</p>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-5">
                                        <div className="bg-[#141c27] rounded-2xl p-6 border border-white/5 shadow-sm transition-colors group hover:border-emerald-300 dark:hover:border-emerald-500/50">
                                            <p className="text-[10px] font-bold text-[#4a5568] mb-3 uppercase tracking-widest group-hover:text-emerald-500 transition-colors">KELDI</p>
                                        ...
                                        <div className="bg-[#141c27] rounded-2xl p-6 border border-white/5 shadow-sm transition-colors group hover:border-rose-300 dark:hover:border-rose-500/50">
                                            <p className="text-[10px] font-bold text-[#4a5568] mb-3 uppercase tracking-widest group-hover:text-rose-500 transition-colors">KELMADI</p>
                                    ...
                                    <div className="bg-white/[0.03] rounded-3xl overflow-hidden shadow-sm border border-white/5 transition-colors">
                                        <table className="w-full text-left border-collapse">
                                            <thead>
                                                <tr className="bg-white/[0.03] border-b border-white/5">
                                                    <th className="p-5 text-[10px] font-bold text-[#4a5568] uppercase tracking-widest">Sana</th>
                                            ...
                                            <tbody className="divide-y divide-white/5">
                                                {currentMonthAttendances.map(a => (
                                                    <tr key={a.id} className="hover:bg-white/[0.02] transition-colors">
                                                        <td className="p-5 text-sm font-bold text-white uppercase tracking-tight">{a.date}</td>
                                                        <td className="p-5">
                                                ...
                                                {currentMonthAttendances.length === 0 && (
                                                    <tr><td colSpan={2} className="p-20 text-center text-[#4a5568] text-[10px] font-bold uppercase tracking-widest">Shu oy bo'yicha ma'lumot yo'q</td></tr>
                                                )}
                                            </tbody>
                                        </table>
                                    </div>
            ...
            {showAttendanceModal && (
                <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-gray-900/60 backdrop-blur-md animate-in fade-in duration-300" onClick={() => setShowAttendanceModal(false)}>
                    <div className="bg-[#1a2332] w-full max-w-sm rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 border border-white/5" onClick={e => e.stopPropagation()}>
                        <div className="p-8 flex items-center justify-between border-b border-white/5 bg-white/[0.03]">
                            <div>
                                <h3 className="text-xl font-bold text-white uppercase tracking-tight">Davomat</h3>
                                <p className="text-[10px] font-bold text-[#4a5568] mt-1.5 uppercase tracking-widest">Bugungi sana uchun</p>
                            </div>
                            <button onClick={() => setShowAttendanceModal(false)} className="w-10 h-10 flex items-center justify-center hover:bg-white/5 border border-transparent hover:border-white/5 rounded-2xl text-gray-400 hover:text-gray-900 dark:hover:text-white transition-all shadow-sm">
                                <XCircle size={22} />
                            </button>
                        </div>
                        <div className="p-8">
...
function StatCardV3({ label, value, subValue, icon, color }: any) {
    ...
    return (
        <div className="bg-[#141c27] p-6 rounded-3xl border border-white/5 shadow-sm hover:shadow-xl hover:shadow-sky-500/5 transition-all hover:-translate-y-1">
            <div className="flex items-start justify-between">
                <div className="space-y-2">
                    <p className="text-[10px] font-bold text-[#4a5568] uppercase tracking-widest">{label}</p>
                    <h5 className="text-2xl font-extrabold text-white tracking-tight leading-none tabular-nums" title={value}>{value}</h5>
                </div>
