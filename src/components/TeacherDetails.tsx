...
export default function TeacherDetails() {
    ...
    if (!teacher) {
        return (
            <div className="p-12 text-center text-gray-550 font-bold text-sm bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-800/50 shadow-sm">
        ...
        <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 items-start">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-800/50 shadow-sm overflow-hidden">
                        <div className="h-28 bg-[#1b6b6b] relative">
                            <div className="absolute -bottom-10 left-1/2 -translate-x-1/2 rounded-2xl bg-white dark:bg-gray-800 p-1 shadow-md">
                                <div className="w-20 h-20 rounded-xl bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-800/50 flex items-center justify-center text-[#1b6b6b] font-bold text-2xl">
                                    {teacher.photo ? (
                ...
                <div className="lg:col-span-3 space-y-6">
                    <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-800/50 shadow-sm overflow-hidden">
                        <div className="flex px-4 bg-gray-55 dark:bg-gray-900/50 border-b border-gray-100 dark:border-gray-800/50 gap-2">
                        ...
                        <div className="p-4">
                                                ...
                                                <div key={group.id} onClick={() => navigate(`/courses/${group.id}`)} 
                                                    ...
                                                    <div className="space-y-4 w-full">
                                                        <div className="flex items-center gap-3">
                                                            <div className="w-10 h-10 rounded-xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-800/50 flex items-center justify-center text-[#1b6b6b] group-hover:bg-[#1b6b6b] group-hover:text-white transition-all shadow-sm">
                            ...
                            {activeTab === 'oylik' && (
                                <div className="space-y-6 animate-in fade-in duration-300">
                                    <div className="bg-gray-50/50 dark:bg-gray-900/40 p-4 border border-gray-100 dark:border-gray-800/50 rounded-2xl">
                                        <h4 className="text-xs font-black text-gray-900 dark:text-white tracking-tight">Oylik hisob-kitobi</h4>
                                    </div>
                                    
                                    <div className="border border-gray-100 dark:border-gray-800/50 rounded-2xl p-4 bg-white dark:bg-gray-800/50 shadow-sm">
...
function StatCardV3({ label, value, subValue, icon, color }: any) {
    ...
    }[color] || 'bg-gray-50 dark:bg-gray-900 border-gray-100 dark:border-gray-800/50';
