...
function TrialModal({ t, lang, plan, onClose }: TrialModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start sm:items-center-safe justify-center overflow-y-auto bg-slate-950/75 backdrop-blur-md p-4 animate-in fade-in duration-300">
