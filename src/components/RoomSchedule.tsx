                        ...
                        <table className="w-full border-collapse">
                            <thead>
                                <tr className="bg-gray-50/50 dark:bg-gray-900/50 border-b border-gray-100 dark:border-gray-700">
                                    <th className="sticky left-0 z-20 bg-gray-50 dark:bg-gray-900 p-6 min-w-[200px] text-[11px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider text-left border-r border-gray-100 dark:border-gray-700">
                                        Xona nomi
                                    </th>
                                    {timeSlots.map(time => (
                                        <th key={time} className="p-4 min-w-[90px] text-[11px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider text-center border-r border-gray-100/50 dark:border-gray-700/30">
                                            {time}
                                        </th>
                                    ))}
                                </tr>
                        ...
                        <table className="w-full border-collapse">
                            <thead>
                                <tr className="bg-gray-50/50 dark:bg-gray-900/50 border-b border-gray-100 dark:border-gray-700">
                                    ...
                                    {FULL_WEEK.map(day => (
                                        <th key={day.id} className="p-4 min-w-[150px] text-[11px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider text-center border-r border-gray-100/50 dark:border-gray-700/30">
                                            {day.label}
                                        </th>
                                    ))}
                                </tr>
