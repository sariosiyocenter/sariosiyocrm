                      ...
                      <div className="flex flex-wrap items-center gap-3 shrink-0">
                        {[
                          ...
                          <div key={i} className={`rounded-2xl px-5 py-2.5 border text-center min-w-[85px] flex flex-col justify-center ${s.color}`}>
                            <div className="text-[11px] font-extrabold opacity-70 leading-none">{s.label}</div>
                ...
                >
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <span className="px-2.5 py-0.5 bg-violet-50 dark:bg-violet-950/40 border border-violet-100 dark:border-violet-900/50 text-violet-600 dark:text-violet-400 rounded-full text-[11px] font-bold">
                        Agent
                      </span>
                    </div>
                  ...
                  <div className="border-t border-chiziq-mayin/50 pt-4 space-y-3">
                    <div className="grid grid-cols-2 gap-2 text-center">
                      ...
                      <div className="bg-emerald-50/50 dark:bg-emerald-950/10 rounded-xl p-2 border border-emerald-100/30 dark:border-emerald-900/10">
                        <div className="text-[10px] font-extrabold text-emerald-600/80 dark:text-emerald-400/80">Sotildi</div>
