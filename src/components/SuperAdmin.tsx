              ...
              {filteredLeads.map(lead => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="border-t border-gray-50 dark:border-gray-800/50 pt-4 flex items-center justify-between text-[11px] font-extrabold uppercase tracking-wider text-gray-400">
          ...
          <div className="relative bg-white dark:bg-gray-800 rounded-[2rem] border border-gray-100 dark:border-gray-800/50 shadow-2xl w-full max-w-2xl p-8 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleUpdateSubscription} className="space-y-6">
              ...
              <div className="space-y-4">
                <h4 className="text-[11px] font-bold text-gray-400 uppercase tracking-wider pb-1 border-b border-gray-50 dark:border-gray-800/30">Tashkilot Ma'lumotlari</h4>
              ...
              <div className="space-y-4">
                <h4 className="text-[11px] font-bold text-gray-400 uppercase tracking-wider pb-1 border-b border-gray-50 dark:border-gray-800/30">Obuna Sozlamalari</h4>
              ...
              <div className="space-y-4">
                <h4 className="text-[11px] font-bold text-gray-400 uppercase tracking-wider pb-1 border-b border-gray-50 dark:border-gray-800/30">Admin Akkaunti Ma'lumotlari</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[11px] font-extrabold uppercase tracking-wider text-gray-400 mb-2">Admin Ismi *</label>
                    <input
