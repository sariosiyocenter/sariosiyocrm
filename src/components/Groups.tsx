    ...
    return (
        <div className="space-y-8 pb-12 animate-in fade-in duration-700">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-extrabold text-white uppercase tracking-tight">Guruhlar</h1>
                    <p className="text-[10px] font-bold text-[#4a5568] mt-2 uppercase tracking-widest">Barcha guruhlarni boshqarish jadvali</p>
                </div>
            </div>
                    ...
                    <div className="flex items-center gap-5">
                        ...
                        <button 
                            ...
                            className={`flex items-center gap-3 px-8 py-4 rounded-[1.25rem] text-[10px] font-extrabold uppercase tracking-widest transition-all group shadow-sm border ${
                                ...
                                : 'bg-white/5 text-[#8b9ab2] border-white/10 hover:bg-white/10'
                            }`}
                        >
                    ...
                    <div className="flex items-center gap-4 w-full lg:w-auto">
                        <div className="relative group w-full lg:w-[450px]">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-6 py-4 bg-white/5 border border-white/10 rounded-[1.25rem] text-[10px] font-extrabold uppercase tracking-widest outline-none focus:border-sky-500 focus:ring-4 focus:ring-sky-500/10 transition-all placeholder:text-[#4a5568] text-white"
                            />
                        </div>
                    </div>
                </div>
                ...
                {showFilters && (
                    <div className="px-8 pb-8 pt-2 border-t border-white/5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-6 animate-in slide-in-from-top-4 duration-500">
                        <div className="space-y-3">
                            <label className="text-[9px] font-extrabold text-[#4a5568] uppercase tracking-widest ml-1">Kurs bo'yicha</label>
                            <select 
                        ...
                        <div className="space-y-3">
                            <label className="text-[9px] font-extrabold text-[#4a5568] uppercase tracking-widest ml-1">O'qituvchi</label>
                            <select 
                        ...
                        <div className="space-y-3">
                            <label className="text-[9px] font-extrabold text-[#4a5568] uppercase tracking-widest ml-1">Kunlar</label>
                            <select 
                        ...
                        <div className="space-y-3">
                            <label className="text-[9px] font-extrabold text-[#4a5568] uppercase tracking-widest ml-1">Xona</label>
                            <select 
                        ...
                        <div className="space-y-3">
                            <label className="text-[9px] font-extrabold text-[#4a5568] uppercase tracking-widest ml-1">Vaqt</label>
                            <select 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {filteredGroups.map((group, idx) => (
                    <div
                        ...
                        className="bg-[#141c27] p-8 rounded-[2.5rem] border border-white/5 group cursor-pointer transition-all shadow-sm hover:shadow-2xl hover:shadow-sky-500/10 hover:border-sky-500/30 hover:-translate-y-2 relative overflow-hidden animate-in zoom-in-95 duration-500"
                    ...
                    >
                        ...
                        <div className="flex items-start justify-between mb-8 relative z-10">
                            <div className="flex items-center gap-4">
                                ...
                                <div className="min-w-0 pr-2">
                                    <h3 className="text-xl font-bold text-white group-hover:text-sky-400 transition-colors truncate uppercase tracking-tight">{group.name}</h3>
                                    <p className="text-[10px] font-bold text-[#4a5568] mt-1 truncate uppercase tracking-widest">{group.courseName}</p>
                                </div>
                            </div>
                        ...
                        <div className="grid grid-cols-2 gap-6 py-6 border-y border-dashed border-white/5 -mx-8 px-8 relative z-10 transition-colors group-hover:bg-white/[0.03]">
                            <div className="space-y-1">
                                <span className="text-[10px] font-bold text-[#4a5568] block uppercase tracking-widest">O'qituvchi</span>
                                <span className="text-sm font-bold text-white leading-none truncate block pr-2 uppercase tracking-tight" title={getTeacherName(group.teacherId)}>{getTeacherName(group.teacherId)}</span>
                            </div>
                            <div className="text-right space-y-1">
                                <span className="text-[10px] font-bold text-[#4a5568] block uppercase tracking-widest">Vaqt & Kunlar</span>
                                <span className="text-sm font-bold text-white leading-none truncate block uppercase tracking-tight tabular-nums">
                        ...
                        <div className="flex items-center justify-between mt-6 pt-1 relative z-10">
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/5 flex items-center justify-center text-[#4a5568] group-hover:text-sky-500 transition-all">
                                    <Users size={18} />
                                </div>
                                <div>
                                    <span className="text-[10px] font-bold text-[#4a5568] block uppercase tracking-widest leading-none mb-1">O'quvchilar</span>
                                    <span className="text-sm font-extrabold text-white uppercase tracking-tight">{group.studentsCount} ta</span>
                                </div>
                            </div>
                            <div className="w-10 h-10 flex items-center justify-center rounded-xl bg-white/5 border border-white/5 group-hover:bg-sky-600 group-hover:text-white group-hover:border-sky-600 text-[#4a5568] transition-all">
                ...
                {filteredGroups.length === 0 && (
                    <div className="col-span-full py-32 text-center border-2 border-dashed border-white/5 rounded-[3rem] bg-white/[0.02] animate-in fade-in duration-500 scale-95">
                        <Users className="w-20 h-20 text-[#1e2d3d] mx-auto mb-6" />
                        <h3 className="text-xl font-bold text-white mb-2 uppercase tracking-tight">Guruhlar topilmadi</h3>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-gray-900/60 backdrop-blur-md animate-in fade-in duration-300" onClick={() => setIsModalOpen(false)}>
                    <div className="bg-[#1a2332] w-full max-w-lg rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 border border-white/10" onClick={e => e.stopPropagation()}>
                        <div className="px-10 py-8 flex items-center justify-between border-b border-white/5 bg-white/5">
                            <div>
                                <h2 className="text-2xl font-bold text-white uppercase tracking-tight">Yangi Guruh</h2>
                                <p className="text-[10px] font-bold text-[#4a5568] mt-1.5 uppercase tracking-widest">Yangi guruh ma'lumotlarini kiriting</p>
                            </div>
                        ...
                        <form onSubmit={handleAddGroup} className="p-10 space-y-8">
                            <div className="space-y-3">
                                <label className="text-[10px] font-bold text-[#4a5568] uppercase tracking-widest ml-1">Guruh nomi <span className="text-rose-500">*</span></label>
                                <input required type="text" placeholder="Masalan: Frontend #12" className="w-full px-6 py-4 bg-white/5 border border-white/10 rounded-[1.25rem] text-xs font-bold uppercase tracking-widest focus:border-sky-500 focus:ring-4 focus:ring-sky-500/10 outline-none transition-all text-white placeholder:text-[#4a5568]"
                            ...
                            <div className="grid grid-cols-2 gap-8">
                                <div className="space-y-3">
                                    ...
                                    <input required type="text" placeholder="Frontend" className="w-full px-6 py-4 bg-white/5 border border-white/10 rounded-[1.25rem] text-xs font-bold uppercase tracking-widest focus:border-sky-500 focus:ring-4 focus:ring-sky-500/10 outline-none transition-all text-white placeholder:text-[#4a5568]"
                                        value={newGroup.courseName} onChange={e => setNewGroup({ ...newGroup, courseName: e.target.value })} />
                                </div>
                                <div className="space-y-3">
                                    <label className="text-[10px] font-bold text-[#4a5568] uppercase tracking-widest ml-1">O'qituvchi <span className="text-rose-500">*</span></label>
                                    <select required className="w-full px-6 py-4 bg-white/5 border border-white/10 rounded-[1.25rem] text-xs font-bold uppercase tracking-widest focus:border-sky-500 focus:ring-4 focus:ring-sky-500/10 outline-none transition-all cursor-pointer text-white appearance-none"
                            ...
                            <div className="grid grid-cols-2 gap-8">
                                <div className="space-y-3">
                                    <label className="text-[10px] font-bold text-[#4a5568] uppercase tracking-widest ml-1">Kunlar <span className="text-rose-500">*</span></label>
                                    <select 
                                        required 
                                        className="w-full px-6 py-4 bg-white/5 border border-white/10 rounded-[1.25rem] text-xs font-bold uppercase tracking-widest focus:border-sky-500 focus:ring-4 focus:ring-sky-500/10 outline-none transition-all cursor-pointer text-white appearance-none"
                                        value={newGroup.days} 
                                ...
                                <div className="space-y-3">
                                    <label className="text-[10px] font-bold text-[#4a5568] uppercase tracking-widest ml-1">Xona <span className="text-rose-500">*</span></label>
                                    <select 
                                        required 
                                        className="w-full px-6 py-4 bg-white/5 border border-white/10 rounded-[1.25rem] text-xs font-bold uppercase tracking-widest focus:border-sky-500 focus:ring-4 focus:ring-sky-500/10 outline-none transition-all cursor-pointer text-white appearance-none"
                                        value={newGroup.room} 
                            ...
                            <div className="grid grid-cols-2 gap-8">
                                <div className="space-y-3">
                                    <label className="text-[10px] font-bold text-[#4a5568] uppercase tracking-widest ml-1">Boshlanish Vaqti <span className="text-rose-500">*</span></label>
                                    <input required type="time" className="w-full px-6 py-4 bg-white/5 border border-white/10 rounded-[1.25rem] text-xs font-bold uppercase tracking-widest focus:border-sky-500 focus:ring-4 focus:ring-sky-500/10 outline-none transition-all text-white"
                                        value={newGroup.startTime} onChange={e => setNewGroup({ ...newGroup, startTime: e.target.value })} />
                                </div>
                                <div className="space-y-3">
                                    <label className="text-[10px] font-bold text-[#4a5568] uppercase tracking-widest ml-1">Tugash Vaqti <span className="text-rose-500">*</span></label>
                                    <input required type="time" className="w-full px-6 py-4 bg-white/5 border border-white/10 rounded-[1.25rem] text-xs font-bold uppercase tracking-widest focus:border-sky-500 focus:ring-4 focus:ring-sky-500/10 outline-none transition-all text-white"
